...
public class MyCart {
	...
	/*
	 * 4. add(상품들의 부모타입) : void 매개변수로 넘어온 상품을 cart배열에 순서대로 담아줍니다. 단, cart배열이 꽉 찼다면,
	 * 2배 크기의 카트배열로 옮겨주세요.
	 * 
	...
	/*
	 * 5.info() 장바구니 안에 담긴 물건의 목록(name)을 출력한다. 장바구니 안에 담긴 물건의 가격을 모두 더해서 출력
	 * 
	...
	public void info() {
		...
		for (int n = 0; n < i; n++) {
			System.out.print(cart[n].getName() + " ");
		}
		System.out.println();
		for (int n = 0; n < i; n++) {
			sum += cart[n].getPrice();
